...
@Module({
    imports:[TypeOrmModule.forFeature([Postagem]),TemaModule],//"Dentro deste módulo, quero disponibilizar o repositório da entidade Postagem para que eu possa injetá-lo e manipular os dados dessa tabela."
